...
public class MultiplayerManager : MonoBehaviour
{
    ...
    public async void FindMatch()
    {
        ...
        UIManager._instance.TerminalMessage("Find match","Loking for a lobby");
        ...
        try
        {
            ...
            UIManager._instance.TerminalMessage("Joined lobby: " + lobby.Id, "Lobby Players: " + lobby.Players.Count);
    ...
    private async void CreateMatch()
    {
        ...
        UIManager._instance.TerminalMessage("Creating match", "Creating a new lobby");
        ...
        try
        {
            ...
            UIManager._instance.TerminalMessage("Create match", "Waiting for players");
        }
        catch (LobbyServiceException e)
        {
            Console.WriteLine(e);

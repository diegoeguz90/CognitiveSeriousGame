...
public class GameServicesManager : MonoBehaviour
{
    ...
    // Singleton
    public static GameServicesManager _instance;
    public static GameServicesManager Instance => _instance;
    ...
    private void ClientConnected(ulong id)
    {
        ...
        UIManager._instance.TerminalMessage("Player ID: ",id.ToString());
